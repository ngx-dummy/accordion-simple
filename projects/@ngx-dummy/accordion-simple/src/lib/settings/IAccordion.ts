...
export interface AccordionItem {
	 ...
	 * @member {Object} body - complex object containing {@link ItemTemplateContext.itemTemplate} - { import("@angular/core").TemplateRef } to provide custom accordion item body
